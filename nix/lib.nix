# Builds the logos-storage-ui library
{ pkgs, common, src, logosStorageModule, logosSdk }:
...
pkgs.stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    if [ -f modules/storage_ui.dylib ]; then
      cp modules/storage_ui.dylib $out/lib/
    elif [ -f modules/storage_ui.so ]; then
      cp modules/storage_ui.so $out/lib/
    else
